<?php 
    ...
    $dep_name = str_replace(' ', '%20', $_SESSION['user']['department']);
    $curl = curl_init('http://localhost/uni_comm/api/posts/read_by_dep.php?dep_name=' . $dep_name);
    curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
    $posts = json_decode(curl_exec($curl), true);

    $curl = curl_init('http://localhost/uni_comm/api/users/read_by_dep.php?dep_name=' . $dep_name);
    curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
                    ...
                    <div class="col-md-8 col-xl-6 middle-wrapper ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 grid-margin">
                                ...
                                <div class="main-page">
                                <h2 class="main-font"> <?php echo $_SESSION['user']['department'] ?> </h2>
                                    <button type="button" class="btn btn-light post-btn" data-toggle="modal" data-target="#creatPost">
                                        New post
                                    </button>
                                    <button type="button" class="btn btn-light view-btn" data-toggle="modal" data-target="#viewStudentsList">
                                        View Student list
                                    </button>
                                </div>
                                ...
                                <div class="modal fade" id="viewStudentsList" tabindex="-1" role="dialog"
                                    aria-labelledby="newPostTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
